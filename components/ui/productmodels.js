  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[0.2, 87.61, -53.42]} rotation={[0, 0, -Math.PI]}>
        ...
        <mesh geometry={nodes.verb_1.geometry} material={materials.anthracite} position={[3.64, 24.97, 47.9]} rotation={[0, 0, -Math.PI]} />
      </group>
      <group position={[-4.91, 43.05, -53.07]}>
        <group position={[1.45, -48.07, 46.54]}>
          <mesh geometry={nodes['w2profile-anthracite'].geometry} material={materials.anthracite} />
