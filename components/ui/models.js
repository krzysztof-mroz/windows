  ...
  export function K76Ad({ ...props }) {
    ...
    return (
      <group ref={group} {...props} dispose={null}>
        ...
        <mesh geometry={nodes.glas.geometry} material={nodes.glas.material} position={[0.12, 1.98, -2.21]} material-roughness={0.25}
        material-clearcoat={1}
        material-reflectivity={1}
        material-transparent
        material-opacity={0.92}
  ...
  export function Pe68({ ...props }) {
    ...
    return (
      <group ref={group} {...props} dispose={null}>
        ...
        <mesh geometry={nodes.glas.geometry} material={nodes.glas.material} position={[-0.21, 1.1, -2.28]} material-roughness={0.25}
        material-clearcoat={1}
        material-reflectivity={1}
        material-transparent
        material-opacity={0.92}
  ...
  export function Aws90({ ...props }) {
    ...
    return (
      <group ref={group} {...props} dispose={null}>
        ...
        <mesh geometry={nodes.glas.geometry} material={nodes.glas.material} position={[1.08, 2.54, -1.91]} material-roughness={0.25}
        material-clearcoat={1}
        material-reflectivity={1}
        material-transparent
        material-opacity={0.92}
