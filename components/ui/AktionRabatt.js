      ...
      <div className="ba b--solid bw1" style={{ backgroundColor: '#f5f5dc' }}> {/* Beige Hintergrund */}
        ...
        <div className="flex flex-column pa3">
          <div className="w-100">
            ...
            Bestellen Sie zwischen 30 April und 12 Mai 2024 und erhalten Sie <span className="b">10% Sonderrabatt</span> auf Salamander und Aluplast Fenster
            </p>
          </div>
          <div className="w-100">
            <p className="lh-copy i f7 tc"> {/* Kleinere Schriftgröße und zentrierter Text */}
              *Diese Aktion gilt nur für Angebote ab dem 30 April 2024
            </p>
          </div>
        </div>
      </div>
