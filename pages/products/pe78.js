...
import image1 from "../../public/pe78_mahagoni.jpg";
import image2 from "../../public/pe78_anthr_2.jpg";
import image3 from "../../public/pe78_farngruen_3.jpg";
import image_querschnitt from "../../public/pics/sections/pe78.png";
...
function Pe78() {
  ...
  return (
    <Fragment>
      <Head>
        <title>Polnische Fenster Aluminium Ponzio PE 78 N</title>
        <meta
          name="description"
          content="Aluminium Fenster PE 78 N. 3d Visualisierung"
        />
        <meta
          name="keywords"
          content="fenster, aluminium fenster, fenster aus polen, ponzio, pe 78"
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <HeaderDiv title="Ponzio PE 78 N Aluminium Fenster"/>
      <Visualisation profil="Ponzio PE 78N" showProfiles="no" />

      <div className="flex flex-wrap justify-around mb3 w-100 tc">
        <div className="w-100 w-40-l mt1 mt5-l">
          <h5 className="gray">Ponzio PE 78 N Fenster</h5>
        ...
        <div className="w-100 w-40-l ma2 silver">
          <Image src={image1} alt="Ponzio PE 78 N" />
        </div>
      </div>

      <div className="flex flex-wrap justify-around mb3 w-100 tc">
        <div className="w-100 w-40-l ma2 mt5-l">
          <Image src={image2} alt="Ponzio PE 78 N" />
        </div>
        <div className="w-100 w-40-l ma2 mt5-l">
          <Image src={image3} alt="Ponzio PE 78 N" />
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-around mb3 mh4-l mt5 w-100 tc">
        ...
        <Image src={image_querschnitt} alt="Ponzio PE 78 N" />
        </div>
      </div>
