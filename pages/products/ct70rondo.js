...
import image1 from "../../public/ct_70_rondo_weiss.jpg";
import image2 from "../../public/ct_70_rondo_anthr_2.jpg";
import image3 from "../../public/ct_70_classic_goldenoak_3.jpg";
import image_querschnitt from "../../public/pics/sections/ct70rondo.png";
    ...
    <Fragment>
      ...
      <div className="flex flex-wrap justify-around mb3 w-100 tc">
        <div className="w-100 w-40-l mt1 mt5-l">
          <h5 className="gray">Schüco CT 70 Rondo Fenster</h5>
        ...
        <div className="w-100 w-40-l ma2 silver">
          <Image src={image1} alt="Schüco CT 70 Rondo" />
        </div>
      </div>

      <div className="flex flex-wrap justify-around mb3 w-100 tc">
        <div className="w-100 w-40-l ma2 mt5-l">
          <Image src={image2} alt="Schüco CT 70 Rondo" />
        </div>
        <div className="w-100 w-40-l ma2 mt5-l">
          <Image src={image3} alt="Schüco CT 70 Rondo" />
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-around mb3 mh4-l mt5 w-100 tc">
        ...
        <Image src={image_querschnitt} alt="Schüco CT 70 Rondo" />
        </div>
      </div>
