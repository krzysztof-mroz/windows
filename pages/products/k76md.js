...
import image1 from "../../public/k76_md_db703.jpg";
import image2 from "../../public/k76_md_weiss_2.jpg";
import image3 from "../../public/k76_md_golden_oak_3.jpg";
import image_querschnitt from "../../public/pics/sections/k76md.png";
...
/>,
  ...
  return (
    <Fragment>
      <Head>
        <title>Polnische Fenster Kömmerling 76 MD</title>
        <meta
          name="description"
          content="Kömmerling 76 MD Kunststoff Fenster. 3d Visualisierung"
        />
        <meta
          name="keywords"
          content="fenster, kunststoff fenster, fenster aus polen, kömmerling, k 76 md"
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <HeaderDiv title="Kömmerling 76 MD Kunststofffenster" />
      <Visualisation profil="Kömmerling 76 MD" showProfiles="no" />

      <div className="flex flex-wrap justify-around mb3 w-100 tc">
        <div className="w-100 w-40-l mt1 mt5-l">
          <h5 className="gray">Kömmerling 76 MD Fenster</h5>

          <div className="gray f6 tl">
            <ul>
            <li>6 Luftkammer für gute Wärmedämmung,</li>
        ...
        <div className="w-100 w-40-l ma2 silver">
          <Image src={image1} alt="Kömmerling 76 MD" />
        </div>
      </div>

      <div className="flex flex-wrap justify-around mb3 w-100 tc">
        <div className="w-100 w-40-l ma2 mt5-l">
          <Image src={image2} alt="Kömmerling 76 MD" />
        </div>
        <div className="w-100 w-40-l ma2 mt5-l">
          <Image src={image3} alt="Kömmerling 76 MD" />
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-around mb3 mh4-l mt5 w-100 tc">
        ...
        <Image src={image_querschnitt} alt="Kömmerling 76 MD" />
        </div>
      </div>
