...
export default function AnfrageHTALUPage() {
  ...
  const [form, setForm] = useState({
    ...
    farbeAussen: "Weiß RAL 9016 Matt",
  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await fetch("/api/anfragehtalu", {
        method: "POST",
        headers: {
      ...
      router.push("/kontakt/anfrage/dankehtalu");
    } catch (err) {
  ...
  return (
    <>
      <Head>
        <title>Anfrage Aluminium Haustüren</title>
        <meta
          name="description"
          content="Anfrageformular für Aluminium Haustüren aus Polen."
        />
      </Head>

      <section className="wrap">
        <div className="card">
          <h1 className="title">Anfrage Aluminium Haustür</h1>
          ...
          <form onSubmit={handleSubmit} className="form">
            ...
            <div>
              ...
              <select name="aussen" value={form.aussen} onChange={handleChange}>
                ...
                <option value="Eingelassener Griff">Eingelassener Griff</option>
