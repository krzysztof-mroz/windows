    ...
    <div className=" w-100-l">
      <div className="fw9 pv1 tl dt w-100">
        <div className="dtc v-mid tc pa1" style={{overflow: "hidden", position: "fixed", top: 0, width: "100%", marginBottom: "70px", zIndex: 999, height: "50px", backgroundColor: "#FFFFFF" }}>
          ...
          <Link href="/">
            <a className="f6 fw4 dim no-underline db dib pv2 ph3">
              Sign Up
            </a>
          </Link>
          </div>
        ...
        <div className="mh2 mh4-ns mh6-l mw9 ">
          ...
          <div className="flex flex-wrap justify-center  w-100 pa2 tc  ">
            <div className="w-100 ba b--moon-gray pa2">
              <img className="mh4 mb4 mv1-l ph3 db dib-l center" src="./pics/logos/logo_profine.png"></img>
              <img className="mh4 mv4 mv1-l ph3 db dib-l center" src="./pics/logos/logo_aluprof.png"></img>
              <img className="mh4 mv4 mv1-l ph3 db dib-l center" src="./pics/logos/logo_ponzio.png"></img>
              <img className="mh4 mv4 mv1-l ph3 db dib-l center" src="./pics/logos/logo_winkhaus.png"></img>
              <img className="mh4 mv4 mv1-l ph3 db dib-l center" src="./pics/logos/logo_hoppe.png"></img>
              <img
